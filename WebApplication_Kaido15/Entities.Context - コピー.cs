...
namespace WebApplication_Kaido15
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual int sp_GetStudent(Nullable<int> pageNo, Nullable<int> pageSize)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_GetStudent", pageNoParameter, pageSizeParameter);
        }
